...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            ...
            <form action="<%= request.getContextPath() %>/sellers/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="field_email" placeholder="nome@examplo.com">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="baseSalary" name="field_baseSalary">
                </div>
